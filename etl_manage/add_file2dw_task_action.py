...
if __name__ == '__main__':
    ...
    #下载任务
    task.get_task('select etl.*,s.column_name,s.flag from etl_data etl left join structure s on etl.target_id = s.id where etl.type = "load" and etl.db_type = "hive" and etl.is_delete = 0  and log_name="action_log"',ip_list)
